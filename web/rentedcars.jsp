...
%>
<%--<%Car carById=(Car)request.getAttribute("id");%>--%>
        ...
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
            <div class="col-md-9 ftco-animate pb-5">
                <p class="breadcrumbs"><span class="mr-2"><a href="/home">Home <i
                        class="ion-ios-arrow-forward"></i></a></span> <span>RentedCars <i
                        class="ion-ios-arrow-forward"></i></span></p>
                <h1 class="mb-3 bread">Rented Cars</h1>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="car-list">
                    <table class="table">
                        ...
                        <tr class="text-center">
                            <th>&nbsp;</th>
                            <th>&nbsp;</th>
                            <th class="bg-primary heading">Client Name</th>
                            <th class="bg-dark heading">Client Surname</th>
                            <th class="bg-black heading">Client License Number</th>
                        </tr>
                        </thead>
                        <tbody>
                        <%
                        ...
                        <tr class="">
                            <td class="car-image">
                                <div class="img" style="background-image:url(/getImage?picUrl=<%=carById.getPicUrl()%>);"></div>
                            </td>
                            <td class="product-name">
                                <h3><%=carById.getBrand()%>></h3>
                                <p class="mb-0 rated">
                                    <span>rated:</span>
                            ...
                            <td class="price">
                                <div class="price-rate">
                                    <h3>
                                        <span class="num"><small class="currency"></small> <%=client.getName()%></span>
                                    </h3>
                            ...
                            <td class="price">
                                <div class="price-rate">
                                    <h3>
                                        <span class="num"><small class="currency"></small> <%=client.getSurName()%></span>
                                    </h3>
                                    <span class="subheading"></span>
                                </div>
                            </td>
                            ...
                            <td class="price">
                                <div class="price-rate">
                                    <h3>
                                        <span class="num"><small class="currency"></small><%=client.getDriverLicenseNumber()%></span>
                                    </h3>
                                    <span class="subheading"></span>
                                </div>
                            </td>
